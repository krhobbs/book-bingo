...
function PaginationLink({
  ...
  return (
    <Link href={href}>
      <Box variant={`links.pagination${active ? 'Active' : ''}`}>
        {children}
      </Box>
    </Link>
  );
...
function Pagination({
  ...
  return (
    ...
    >
      ...
      >
        <Box variant={`links.pagination${prevDisabled ? 'Disabled' : ''}`}>
          Prev
        </Box>
      </Link>
      ...
      >
        <Box variant={`links.pagination${nextDisabled ? 'Disabled' : ''}`}>
          Next
        </Box>
      </Link>
    </Box>
